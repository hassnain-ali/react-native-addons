...
namespace margelo::nitro::addons {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/addons/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/addons/Func_void_cxx;";
