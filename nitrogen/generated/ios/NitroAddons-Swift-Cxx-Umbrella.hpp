///
/// NitroAddons-Swift-Cxx-Umbrella.hpp
...
#if __has_include("NitroAddons-Swift.h")
// This header is generated by Xcode/Swift on every app build.
// If it cannot be found, make sure the Swift module's name (= podspec name) is actually "NitroAddons".
#include "NitroAddons-Swift.h"
// Same as above, but used when building with frameworks (`use_frameworks`)
#elif __has_include(<NitroAddons/NitroAddons-Swift.h>)
#include <NitroAddons/NitroAddons-Swift.h>
#else
#error NitroAddons's autogenerated Swift header cannot be found! Make sure the Swift module's name (= podspec name) is actually "NitroAddons", and try building the app first.
#endif
